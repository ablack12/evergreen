...
type VersionBuildStatus struct {
	...
	BatchTimeTasks   []TaskWithBatchTime `bson:"tasks_with_batchtime,omitempty" json:"tasks_with_batchtime,omitempty"`
	ActivationStatus `bson:",inline"`
}

type TaskWithBatchTime struct {
...
var (
	...
	TaskWithBatchTimeTaskNameKey  = bsonutil.MustHaveTag(TaskWithBatchTime{}, "TaskName")
	TaskWithBatchTimeActivatedKey = bsonutil.MustHaveTag(TaskWithBatchTime{}, "Activated")
)
